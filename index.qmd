...
**🚪 Treat the README as the front door**
The first file in a repository should tell someone what the project is, how to start, where the data lives, and who maintains it.
...
Before you call a repository "done enough", ask:
